...
export declare const DIFFUSERS_SAFETENSORS_FILE = "diffusion_pytorch_model.safetensors";
export declare const DIFFUSERS_SAFETENSORS_INDEX_FILE = "diffusion_pytorch_model.safetensors.index.json";
export declare const DIFFUSERS_WEIGHTS_SUBFOLDERS: readonly ["transformer", "unet"];
