...
class ChangelogDialog(wx.Dialog):
	def __init__(self, parent):
		...
		changelog_text = (
			...
			"* Perbaikan API Store: Menambahkan User-Agent pada permintaan hapus paket suara agar tidak terblokir oleh Cloudflare WAF (Error 403).\n\n"
			"--- Versi 1.7.0 ---\n"
			...
			"* Perbaikan Telemetri: Laporan Telegram kini mengirimkan versi NVDA Add-on secara dinamis, menghilangkan laporan palsu versi 1.6.2.\n\n"
			"--- Versi 1.6.8.1 (Hotfix Dependensi Vosk Lanjutan) ---\n"
